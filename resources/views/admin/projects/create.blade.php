        ...
        <div>
            <div class="form-card" style="margin-bottom:1.5rem">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" placeholder="Describe what this project is about, what problem it solves..." required>{{ old('description') }}</textarea>
        ...
        <div>
            ...
            <div class="form-card" style="margin-bottom:1.5rem">
                ...
                <div style="display:flex; flex-wrap:wrap; gap:0.5rem">
                    ...
                    <label style="display:flex; align-items:center; gap:0.4rem; padding:0.3rem 0.6rem; border-radius:8px; border:1px solid var(--border); cursor:pointer; font-size:0.85rem; transition: all 0.2s; user-select:none"
...
<script>
    ...
    // Sync checkbox state with label
